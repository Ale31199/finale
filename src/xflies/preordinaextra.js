...
import alienok from './ximg/alien-head.png';
import alienerror from './ximg/alien-head1.png';
...
function Preordina(){
    ...
    const [tot, settot]=useState(1799)
    ...
    const [immagine, setimmagine]=useState(alienok)
    const [showbiglietto, setshowbiglietto]=useState(false)
    ...
    const inviaRice=()=>{
        ...
        setmess(`Grazie ${nome} per aver acquistato il biglietto! La tua ricevuta è stata inviata con successo a ${email}. 
            ...
            setTimeout(()=>{
            setmess('Uhmmm sembrano mancare dei dati nei campi obbligatori, ricontrolla e riprova.')
            setimmagine(alienerror)
            setshowbiglietto(true)
            },2300)
        }
    }
...
<div className='preorder'>
  <div className='preorderbox'>
   <img src={solar} className='preorderimg'></img>
   <div className='pretextbox'>
    <h1 className='pretitle'>Biglietto per Interspazio</h1>
...
<div className='confirm' style={showb}>
  <div className='confirmbox'>
   <img src={immagine} className='confirmimg'></img>
   <div className='confirmtextbox'>
    
   <h2 className='grazietext'>{mess}</h2>
